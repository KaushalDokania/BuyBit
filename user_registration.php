        ...
        <div class="container">
            ...
            <form method="post" action="">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputFName" placeholder="First Name" name="fname" /><br/>
                    <input type="text" class="form-control" id="exampleInputMName" placeholder="Middle Name" name="mname"/><br/>
                    <input type="text" class="form-control" id="exampleInputLName" placeholder="Last Name" name="lname" /><br/>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputGender">Gender&nbsp;&nbsp;&nbsp;</label>
                    <input type="radio" id="exampleInputPMale" name="gender" value="Male" />&nbsp;&nbsp;&nbsp;Male
                    <input type="radio" id="exampleInputPMale" name="gender" value="Female"/>&nbsp;&nbsp;&nbsp;Female
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Enter password again" name="password"/>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputAddress">Address</label>
                    <textarea class="form-control" id="exampleInputadress" rows=4 placeholder="Enter full address" name="address"></textarea>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Phone</label>
                    <input type="text" class="form-control" id="exampleInputPhone" value="+91" maxlength=13 name="phone"/>
                  </div>
                  ...
                  <button type="submit" class="btn btn-default" name="new_user_submit">Register</button>
            </form>
